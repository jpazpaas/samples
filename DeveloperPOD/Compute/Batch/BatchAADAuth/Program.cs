...
namespace BatchDotNetQuickstart
{
    public class Program
    {
        ...
        // Batch account AAD credentials
        private const string AuthorityUri = "https://login.microsoftonline.com/{TenantId}";
        private const string BatchResourceUri = "https://batch.core.windows.net/";
        private const string BatchAccountUrl = "https://{accountname}.{region}.batch.azure.com";
        private const string ClientId = "{ClientID}";
        private const string ClientKey = "{ClientSecret}";

        // Storage account credentials
        private const string StorageAccountName = "{YourStorageAccountName}";
        private const string StorageAccountKey = "{YourStorageAccountKey}";

        // Batch resource settings
        private const string PoolId = "AADAuthPool";
        private const string JobId = "AADAuthJob";
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                // Get a Batch client using aad creds
                Func<Task<string>> tokenProvider = () => GetAuthenticationTokenAsync();
                using (BatchClient batchClient = BatchClient.Open(new BatchTokenCredentials(BatchAccountUrl, tokenProvider)))
                {
